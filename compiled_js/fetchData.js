...
var queryDB = function (sqlCommand) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        con.connect(function (connectionErr) {
            ...
            con.query({ sql: sqlCommand, timeout: 2000 }, function (queryErr, result) {
                if (queryErr) {
                    console.log("Throwing query err: ", queryErr === null || queryErr === void 0 ? void 0 : queryErr.sqlMessage);
                    reject(queryErr === null || queryErr === void 0 ? void 0 : queryErr.sqlMessage);
                }
                if (result) {
                    con.end();
                    resolve(result);
